...
The current template setup uses GitHub Actions to build a website automatically from the `docs` folder. The current settings override some of the usual defaults to enable using Quarto. This greatly simplifies many things about rendering documentation to HTML and websites, as well as making it easier to render into books or Word documents later; the website-publishing process is now fully automated.
...
## Quarto
The current setup no longer requires installation of Quarto on your local machine. However, Quarto is still a useful tool. To install, visit the [Quarto install page](https://quarto.org/docs/get-started/) and follow instructions for your operating system. A sub-page will be created soon for more information.