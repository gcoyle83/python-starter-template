...
## Documentation
Documentation is a vital part of any Python project. See the [documentation tools page](tools/documentation.qmd) for a review of using some recommended tools for documenting projects.
