...
:::{.callout-important}
Docs builds are now fully automated. Simply create/edit pages in the `write_docs` directory and commit/push changes as normal. The build/deploy workflow will run automatically. For more info, see [Documentation](tools/documentation.qmd#authoredit-documentation)
:::
